...
class ESAMCCLIP11Dataset(Dataset):
    def __init__(
        ...
        **extra_kwargs,
        ...
        LOGGER.info("positive stats raw=%s", self.stats.get("positive_raw", {}))
        LOGGER.info("positive stats after rebalance=%s", self.stats.get("positive_rebalanced", {}))
        LOGGER.info("rebalance summary=%s", self.stats.get("rebalance", {}))
    ...
    def _build_samples(self):
        ...
        for sample in positives:
            ...
            if prompt in self.old_classes:
                ...
                rebalance_stats["other_positive_kept"] += 1
            if keep:
